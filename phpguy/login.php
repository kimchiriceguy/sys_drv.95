...
<body>
  ...
  <div class="wrong_password_popup" id="wrong_password_popup">
    <div class="header_table">
      <div class="header_text">
        Incorrect Password!
      </div>
    ...
    <div class="static_text_container">
      <table>
        <td style="font-family: w95fa; font-size: 15px; margin-left: 20px">The password you entered is incorrect. Please try again.</td>
      </table>
    </div>
    <button class="popup_table_close" id="wrong_password_popup_close">Close</button>
  </div>
